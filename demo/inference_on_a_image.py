...
from utils.GD_utils import nms_boxes
...
if __name__ == "__main__":
    ...
    parser.add_argument("--box_threshold", type=float, default=0.1, help="box threshold") # previously 0.3 by default
    parser.add_argument("--text_threshold", type=float, default=0.1, help="text threshold") # previously 0.25 by default
    ...
    boxes_filt, pred_phrases = get_grounding_output(
        model, image, text_prompt, box_threshold, text_threshold, cpu_only=args.cpu_only, token_spans=eval(f"{token_spans}"), nms=True
    )
